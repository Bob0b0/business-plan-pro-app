...
# Inizializza df_pivot_by_id_ri_year e id_ri_to_ricla_name anche se df_full_data è vuoto
...
# --- Visualizzazione della Tabella Riclassificata (Rendering riga per riga) ---
