...
report_structure_sp = [
    ...
    {'Voce': 'Altri crediti m.l.t.', 'Tipo': 'Dettaglio', 'ID_RI': 'RI34', 'Ordine': 535},

    {'Voce': 'CAPITALE INVESTITO', 'Tipo': 'Calcolo', 'Formula_Refs': ['RI19', 'RI20', 'RI21', 'RI22', 'RI23', 'RI24', 'RI25', 'RI26', 'RI27', 'RI28', 'RI29', 'RI30','RI34'], 'Formula': lambda d: d.get('RI19', 0) + d.get('RI20', 0) + d.get('RI21', 0) + d.get('RI22', 0) + d.get('RI23', 0)+ d.get('RI34', 0) - d.get('RI24', 0) + d.get('RI25', 0) + d.get('RI26', 0) - d.get('RI27', 0) - d.get('RI28', 0) - d.get('RI29', 0) - d.get('RI30', 0), 'Grassetto': True, 'Maiuscolo': True, 'Ordine': 540},
...
{'Voce': 'Variazione TFR, fondi e altri mlt', 'Tipo': 'Calcolo', 'Formula_Refs': ['RI28_current', 'RI29_current', 'RI30_current', 'RI34_current', 'RI28_previous', 'RI29_previous', 'RI30_previous', 'RI34_previous'], 'Formula': lambda d: ((d.get('RI28_current', 0) + d.get('RI29_current', 0) + d.get('RI30_current', 0)) - (d.get('RI28_previous', 0) + d.get('RI29_previous', 0) + d.get('RI30_previous', 0)) - (d.get('RI34_current', 0) - d.get('RI34_previous', 0))), 'Grassetto': False, 'Maiuscolo': False, 'Ordine': 130},  
   ...
   {'Voce': 'Gestione non operativa, accantonamenti e sval.', 'Tipo': 'Calcolo', 'Formula_Refs': ['RI12_current', 'ALTRI COSTI E PROV. NON OP._current'], 'Formula': lambda d: -d.get('RI12_current', 0) + d.get('ALTRI COSTI E PROV. NON OP._current', 0), 'Grassetto': False, 'Maiuscolo': False, 'Ordine': 180},
